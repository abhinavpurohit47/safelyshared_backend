"""
Django settings for safely_shared_backend project.
...
SECRET_KEY = 'django-insecure-zzrp^u#l%&qwj-kc4c9mli)z2i35vb)6g*7qpf*d7phpk6x(wk'
...
WSGI_APPLICATION = 'safely_shared_backend.wsgi.application'
